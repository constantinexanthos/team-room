...
TOOLS = {
    "team_room_ask": {
        "description": (
            ...
            "response is the headline, not the article:\n"
            "  - converged: QUOTE `final_brief.joint_read` verbatim — do not "
            "    paraphrase, do not summarize, do not expand. One short lead-in "
            "    is fine (\"Team Room's read:\"). Nothing else. The joint_read "
            "    is already one or two sentences by design; trust it.\n"
            ...
            "Do NOT paste `messages`, do NOT narrate the deliberation, do NOT "
            "summarize per turn, do NOT include `final_brief` metadata or "
            "`session` info in your text response. The deliberation can be deep; "
            "the surfaced answer should be tight enough to fit in a single line "
            "of chat. If the user wants to see how the team got there, they "
